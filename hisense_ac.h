...
public:
    ...
    void loop() override
    {
        ...
        while (available())
        {
            ...
            if (msg_size > 0)
            {
                ...
                */
                float tgt_temp = (((Device_Status*)uart_buf)->indoor_pipe_temperature);
                target_temperature = tgt_temp;
                //current_temperature = tgt_temp;
    ...
    void update() override
    {
        ...
        this->publish_state();
        float temperature = id(dht_temperature).state; // DHT sensor data
        this->current_temperature = temperature; // Set DHT sensor temperature as current temperature
        // Update sensors
